...
int sprawdz_naladowanie(uint8_t pozycja_x, uint8_t czy_wyswietlic, uint8_t czy_procent){ 
  
  naladowanie = map(analogRead(BATTERY), 2866, 3475, 0, 120);  // Do 120 żeby zrekompensować cahrakterystyke Li-Po która szybko spada na początku, później wolniej
